...
//     //     allRunesConfig.push([rune, bestConfig]);
//     // });
//     // allRunesConfig.sort((a, b) => b[1].efficiencyMax - a[1].efficiencyMax);
//     // allRunesConfig.slice(0, 50).forEach(rune => console.log(logRune(rune[1])));
